...
se connecter avec son compte Discord ; seuls les membres du serveur qui portent le **rôle par
défaut** (`DEFAULT_ROLE_ID`, celui que reçoit tout nouveau membre) entrent. Un membre qui perd ce
rôle, ou quitte le serveur, perd l'accès aussitôt, sans attendre la fin de sa session. `/pk web`
en donne le lien, en réponse privée (ou dit que le site n'est pas en ligne, ou qu'il est réservé
à ce rôle).

| Page | Contenu |
|---|---|
| **Capture** (accueil) | Le Pokémon qui apparaît dans le salon Discord, en direct, avec son sexe et ses balls juste en dessous : rareté, types et difficulté en couleur, chances par ball, ton solde et tes balls en poche, et sa lignée avec ce que tu en possèdes (la fiche du bouton « Infos du Pokémon »). Une ball hors de portée est grisée, sauf si tu en as en poche. Le journal des lancers est sur le côté. On lui **lance ses balls** comme depuis Discord, et on **ramasse** ce qu'un Pokémon laisse tomber. Une apparition qui ne brille que pour les porteurs du [Charme Chroma](pokemon/charme.md) le dit, et s'affiche shiny pour eux. En haut, le bouton du **parc safari**. |
