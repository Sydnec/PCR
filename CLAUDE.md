...
- **Invariants du jeu** : un Pokémon est un individu de `pokemon_owned` (sexe — NULL pour une
  espèce asexuée —, ball, fertilité, date d'arrivée), désigné par son identifiant (`#123`). Une
  entrée du Pokédex est une espèce, shiny ou non : il reste toujours au moins un individu de chaque
