...
- [Site web](docs/site.md) — capture en direct, parc safari, boîte PC à ranger, Pokédex, sac et œuf dans le navigateur, la configuration pour l'administrateur, et son [API](docs/api.md).
