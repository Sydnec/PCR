...
- [Site web](docs/site.md) — capture en direct, parc safari, boîte PC à ranger, Pokédex, sac, œuf et une page Infos qui résume les règles dans le navigateur, la courbe des points et la configuration pour l'administrateur, et son [API](docs/api.md).
